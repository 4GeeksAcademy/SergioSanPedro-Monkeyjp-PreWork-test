...
//----------------------- PARTE PRACTICA -----------------------------
  ...
  let palabraEliminar = 'trampa';
  const inventarioSinTrampa = inventario.filter(item => item !== palabraEliminar);

inventarioSinTrampa.push('super estrella');

inventarioSinTrampa.map(elemento => elemento.toUpperCase(inventarioSinTrampa));
